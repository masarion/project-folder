    ...
    const Mask = (function() {
        ...
        const transformExcelLocaleMask = function(mask) {
            ...
            if (symbolChar === '$') {
                ...
                // Literal symbol provided (e.g., [$$20AC-407])
        ...
        const format = function(str, config) {
            // Extract numeric value from formatted or unformatted string (e.g., "$20B93.00" -> 3)
        ...
        const autoCastingCurrency = function (input, filterDecimal) {
            ...
            for (let i = 0; i < len; i++) {
                ...
                // Currency symbols
                if (char === '$' || char === '$20AC' || char === '$00A3' || char === '$00A5' ||
                    char === '$20B9' || char === '$20BD' || char === '$20A9' || char === '$20AB' || char === '$00A2') {
        ...
        const ParseValue = function(v, config) {
            ...
            if (hasLetters && hasDigits) {
                ...
                cleaned = cleaned.replace(/[A-Z]{1,2}[$20AC$$00A3$00A5$20B9$20BD$20A9$20AB$00A2]/gi, ''); // Remove 1-2 letter prefix + currency symbol (R$, U$, etc.)
                cleaned = cleaned.replace(/[$20AC$$00A3$00A5$20B9$20BD$20A9$20AB$00A2]/g, ''); // Remove remaining currency symbols
        ...
        Component.extract = function(value, options, returnObject) {
            ...
            if (options.locale) {
                ...
                if (type === 'text') {
                    ...
                    // Default fallback $2014 numeric/currency/percent/etc.
